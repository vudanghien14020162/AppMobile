...
class ListMoviesRVAdapter :
    androidx.recyclerview.widget.RecyclerView.Adapter<ListMoviesRVAdapter.MyViewHolder> {
    companion object {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): MyViewHolder {
        val itemView: View = if (i == TYPE_FEATURE) {
            LayoutInflater.from(viewGroup.context)
                .inflate(R.layout.item_vod_horizontal_no_text, viewGroup, false)
        } else {
