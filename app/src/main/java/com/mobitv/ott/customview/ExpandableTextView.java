...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void setCollapse(boolean isCollapsed) {
        ...
        if(itemInListView){
            // notify the listener
            if (mListener != null) {
                mListener.onExpandStateChangedDone(mTv, mCollapsed);
            }
            ...
            if (mCollapsed) {
                ...
                animation = new ExpandCollapseAnimation(this, getHeight(), mMarginBetweenTxtAndBottom + mTextHeightWithMaxLines);
            }
...
//        mTextHeightWithMaxLines = getRealTextViewHeight(mTv);
        mTextHeightWithMaxLines = getRealTextViewHeight(mTv, getWidth());
    ...
    public void setText(@Nullable CharSequence text) {
        mRelayout = true;
//        mTv.setText(text);
        AppUtils.Companion.setTextHtml(mTv,text.toString());
    ...
    private void init(AttributeSet attrs) {
        ...
        itemInListView = typedArray.getBoolean(R.styleable.ExpandableTextView_itemInListView, false);
    ...
    public int getRealTextViewHeight(@NonNull TextView textView, int containerWidth) {
        int widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(containerWidth, View.MeasureSpec.AT_MOST);
    ...
    public interface OnExpandStateChangeListener {
         ...
         * @param isCollapsed - true if the TextView has been collapsed
         */
        void onExpandStateChangedDone(TextView textView, boolean isCollapsed);
    }
